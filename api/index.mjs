...
// packages/infrastructure/validation/actors.ts
var CreateActorSchema = external_exports.object({
...
var CreateCastingSchema = external_exports.object({
  projectId: external_exports.string().uuid(),
  roleName: external_exports.string().min(1).max(200),
  description: external_exports.string().max(2e3).optional(),
...
var CreateRoundSchema = external_exports.object({
  castingId: external_exports.string().uuid(),
  name: external_exports.string().min(1).max(200),
  description: external_exports.string().max(2e3).optional(),
  deadline: external_exports.string().datetime().optional().transform((v) => v ? new Date(v) : void 0),
  order: external_exports.number().int().min(0)
});
var OpenRoundSchema = external_exports.object({
  roundId: external_exports.string().uuid()
});
var CloseRoundSchema = external_exports.object({
  roundId: external_exports.string().uuid()
});

// packages/infrastructure/validation/submissions.ts
var SubmitVideoSchema = external_exports.object({
  roundId: external_exports.string().uuid(),
...
var ManualUploadSchema = external_exports.object({
  roundId: external_exports.string().uuid(),
  actorId: external_exports.string().uuid(),
  videoData: external_exports.string().min(1, "Video data is required"),
  fileName: external_exports.string().min(1, "File name is required").max(200),
  notes: external_exports.string().max(2e3).optional()
});
var ReviewSubmissionSchema = external_exports.object({
  submissionId: external_exports.string().uuid(),
  status: external_exports.enum(["reviewed", "shortlisted", "rejected"]),
  feedback: external_exports.string().max(2e3).optional()
});

// packages/infrastructure/validation/comments.ts
...
var ListCommentsSchema = external_exports.object({
  submissionId: external_exports.string().uuid()
});

// packages/infrastructure/validation/attachments.ts
var AddAttachmentSchema = external_exports.object({
  roundId: external_exports.string().uuid(),
  fileName: external_exports.string().min(1).max(300),
...
// packages/infrastructure/repositories/PrismaActorRepository.ts
var PrismaActorRepository = class {
  async findById(id) {
    return prisma.actor.findUnique({ where: { id } });
  }
  async findByEmail(email) {
    return prisma.actor.findUnique({ where: { email } });
  }
  async findMany(search) {
    ...
    return prisma.actor.findMany({ orderBy: { name: "asc" } });
  }
  async create(actor) {
    return prisma.actor.create({ data: actor });
  }
  async update(actor) {
    return prisma.actor.update({ where: { id: actor.id }, data: actor });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaDirectorRepository.ts
var PrismaDirectorRepository = class {
  async findById(id) {
    return prisma.director.findUnique({ where: { id } });
  }
  async findByEmail(email) {
    return prisma.director.findUnique({ where: { email } });
  }
  async create(director) {
    return prisma.director.create({ data: director });
  }
  async update(director) {
    return prisma.director.update({ where: { id: director.id }, data: director });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaProjectRepository.ts
var PrismaProjectRepository = class {
  async findById(id) {
    return prisma.project.findUnique({ where: { id } });
  }
  async findByDirectorId(directorId) {
    return prisma.project.findMany({ where: { directorId } });
  }
  async create(project) {
    return prisma.project.create({ data: project });
  }
  async update(project) {
    return prisma.project.update({ where: { id: project.id }, data: project });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaCastingRepository.ts
var PrismaCastingRepository = class {
  async findById(id) {
    return prisma.casting.findUnique({ where: { id } });
  }
  async findByProjectId(projectId) {
    return prisma.casting.findMany({ where: { projectId } });
  }
  async create(casting) {
    return prisma.casting.create({ data: casting });
  }
  async update(casting) {
    return prisma.casting.update({ where: { id: casting.id }, data: casting });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaRoundRepository.ts
var PrismaRoundRepository = class {
  async findById(id) {
    return prisma.round.findUnique({ where: { id } });
  }
  async findByCastingId(castingId) {
    return prisma.round.findMany({ where: { castingId }, orderBy: { order: "asc" } });
  }
  async create(round) {
    return prisma.round.create({ data: round });
  }
  async update(round) {
    return prisma.round.update({ where: { id: round.id }, data: round });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaSubmissionRepository.ts
var PrismaSubmissionRepository = class {
  async findById(id) {
    return prisma.submission.findUnique({ where: { id } });
  }
  async findByRoundId(roundId) {
    return prisma.submission.findMany({ where: { roundId } });
  }
  async findByActorId(actorId) {
    return prisma.submission.findMany({ where: { actorId } });
  }
  async create(submission) {
    return prisma.submission.create({ data: submission });
  }
  async update(submission) {
    return prisma.submission.update({ where: { id: submission.id }, data: submission });
  }
  async delete(id) {
...
// packages/infrastructure/repositories/PrismaCommentRepository.ts
var PrismaCommentRepository = class {
  async findById(id) {
...
// packages/infrastructure/repositories/PrismaAttachmentRepository.ts
var PrismaAttachmentRepository = class {
  async findById(id) {
  ...
  async create(attachment) {
    return prisma.attachment.create({ data: attachment });
  }
  async delete(id) {
...
// packages/core/use-cases/projects/CreateProjectUseCase.ts
var CreateProjectUseCase = class {
  constructor(projectRepo, directorRepo) {
...
// packages/core/use-cases/projects/CloseProjectUseCase.ts
var CloseProjectUseCase = class {
  ...
  async execute(dto) {
    ...
    const updated = { ...project, status: "closed", updatedAt: /* @__PURE__ */ new Date() };
...
// packages/core/use-cases/castings/CloseCastingUseCase.ts
var CloseCastingUseCase = class {
...
// packages/core/use-cases/rounds/CreateRoundUseCase.ts
var CreateRoundUseCase = class {
  constructor(roundRepo, castingRepo) {
...
// packages/core/use-cases/rounds/OpenRoundUseCase.ts
var OpenRoundUseCase = class {
  ...
  async execute(dto) {
    ...
    const updated = { ...round, status: "open", updatedAt: /* @__PURE__ */ new Date() };
    const saved = await this.roundRepo.update(updated);
    return { ok: true, data: saved };
  }
};

// packages/core/use-cases/rounds/CloseRoundUseCase.ts
var CloseRoundUseCase = class {
  constructor(roundRepo) {
    this.roundRepo = roundRepo;
  }
  roundRepo;
  async execute(dto) {
    ...
    const updated = { ...round, status: "closed", updatedAt: /* @__PURE__ */ new Date() };
    const saved = await this.roundRepo.update(updated);
    return { ok: true, data: saved };
  }
};

// packages/core/use-cases/actors/CreateActorUseCase.ts
var CreateActorUseCase = class {
...
// packages/core/use-cases/actors/ListActorsUseCase.ts
var ListActorsUseCase = class {
  constructor(actorRepo) {
    this.actorRepo = actorRepo;
  }
  actorRepo;
...
// packages/core/use-cases/submissions/ManualUploadUseCase.ts
var ALLOWED_EXTENSIONS = [".mp4", ".mov", ".webm"];
...
var ManualUploadUseCase = class {
  constructor(submissionRepo, roundRepo, actorRepo) {
  ...
  async execute(dto) {
    ...
    if (round.deadline && /* @__PURE__ */ new Date() > round.deadline) return { ok: false, error: new Error("Submission deadline has passed") };
...
// packages/core/use-cases/submissions/ReviewSubmissionUseCase.ts
var ReviewSubmissionUseCase = class {
...
// packages/core/use-cases/comments/CreateCommentUseCase.ts
var CreateCommentUseCase = class {
  constructor(commentRepo, submissionRepo) {
...
// packages/core/use-cases/comments/ListCommentsUseCase.ts
...
// packages/core/use-cases/attachments/AddAttachmentUseCase.ts
var MAX_SIZE_BYTES2 = 50 * 1024 * 1024;
var AddAttachmentUseCase = class {
  constructor(attachmentRepo, roundRepo) {
  ...
  async execute(dto) {
    ...
    if (dto.fileSize > MAX_SIZE_BYTES2) {
...
// packages/core/use-cases/attachments/ListAttachmentsUseCase.ts
var ListAttachmentsUseCase = class {
  constructor(attachmentRepo, roundRepo) {
    this.attachmentRepo = attachmentRepo;
    this.roundRepo = roundRepo;
  }
...
var MAX_SIZE_BYTES3 = 50 * 1024 * 1024;
function defineRoute(method, path, handler2) {
  const paramNames = [];
  const pattern = path.replace(/:([a-zA-Z]+)/g, (_, name) => {
    paramNames.push(name);
    return "([^/]+)";
  });
  return { method, match: new RegExp(`^${pattern}$`), paramNames, handler: handler2 };
}
var routes = [
  ...
  try {
    const response = await handleUpload({
      ...
      onBeforeGenerateToken: async (pathname, clientPayload) => {
        ...
        const { fileType, fileSize, fileName } = payload;
        ...
        if (fileSize === void 0 || fileSize > MAX_SIZE_BYTES3) throw new Error(`File exceeds 50MB limit (${((fileSize ?? MAX_SIZE_BYTES3 + 1) / 1024 / 1024).toFixed(1)}MB)`);
        return { allowedContentTypes: ALLOWED_TYPES, maximumSizeInBytes: MAX_SIZE_BYTES3, addRandomSuffix: true };
      }
    });
...
async function createCasting(req, res) {
...
async function closeCasting(req, res) {
...
async function removeAttachment(req, res, params) {
